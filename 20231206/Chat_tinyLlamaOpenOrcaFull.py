   ...
   # chat and parameters settings
    with gr.Row():
        ...
        with gr.Column(min_width=50,scale=1):
                with gr.Tab(label="Parameter Setting"):
                    ...
                    gr.Markdown("""
                    ### History lenght
                    Insert how many chat rounds you want to keep as conversation history context
                    """)
                    mem_limit = gr.Slider(
                        minimum=0,
                        maximum=7,
    ...
    def bot(history,t,p,m,r,limit):
        ...
        # Prompt woth context
            ...
            prompt = intro + context + f"Question: {history[-1][0]}<|im_end|>\n<|im_start|>assistant\n"
    ...
    submitBtn.click(user, [msg, chatbot], [msg, chatbot], queue=False).then(
        bot, [chatbot,temperature,top_p,max_length_tokens,rep_pen,mem_limit], chatbot
    )
